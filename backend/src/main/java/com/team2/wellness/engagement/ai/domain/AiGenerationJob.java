...
public class AiGenerationJob {
    ...
    public UUID getId(){return id;} public UUID getRequesterId(){return requesterId;} public UUID getTargetUserId(){return targetUserId;} public UUID getOccurrenceId(){return occurrenceId;} public Status getStatus(){return status;} public int getAttemptCount(){return attemptCount;} public Instant getNextAttemptAt(){return nextAttemptAt;} public String getOutputObjectKey(){return outputObjectKey;} public String getFailureCode(){return failureCode;}
}
